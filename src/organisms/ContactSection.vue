<template>
  <section id="contact" class="section bg-md-light-surface-container/30 dark:bg-md-dark-surface-container/30">
    <div class="container">
      <div class="max-w-4xl mx-auto">
        <h2 class="text-3xl md:text-4xl font-bold text-center mb-8 text-md-light-primary dark:text-md-dark-primary">
          Get in Touch
        </h2>
        
        <p class="text-lg text-center text-md-light-on-surface dark:text-md-dark-on-surface mb-12 max-w-2xl mx-auto">
          I'm always interested in discussing new opportunities, collaborations, or just having a conversation about technology and innovation.
        </p>
        ...
        <div class="bg-md-light-surface dark:bg-md-dark-surface rounded-lg shadow-lg p-6 md:p-8">
          ...
          <div v-if="submitStatus" class="mt-6 p-4 rounded-lg text-center" :class="submitStatusClasses">
            {{ submitMessage }}
          </div>
        </div>

        <div class="mt-12 text-center">
          <p class="text-sm text-md-light-on-surface-variant dark:text-md-dark-on-surface-variant mb-4">
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const response = await fetch('https://docs.google.com/forms/d/e/1FAIpQLSewRzyfbQw30c8dCAIlcVRrvSw2KFRoVxvZNTdOqYj-77QxRg/formResponse', {
      method: 'POST',
      body: formData,
