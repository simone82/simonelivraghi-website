...
const SEO = () => {
  const siteData = {
    ...
    description: 'Experienced AI Systems Engineer and Software Architect based in Milan, Italy. Specializing in machine learning, cloud architecture, and scalable AI solutions.',
